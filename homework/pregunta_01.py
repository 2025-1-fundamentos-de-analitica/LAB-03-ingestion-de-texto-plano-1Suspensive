...
def pregunta_01():
  ...
  df = pd.read_fwf("files/input/clusters_report.txt", widths=[9, 16, 16, 80], names=["Cluster", "Cantidad de palabras clave", "Porcentaje de palabras clave", "Principales palabras clave"], skiprows=4)
  data = []
  cluster = None
